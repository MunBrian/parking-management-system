  ...
  return (
    <>
      ...
      <form className="md:space-y-6" action="#">
        ...
        <div class="grid md:grid-cols-2 md:gap-6 pt-5 mt-5 border-t border-gray-200 dark:border-gray-700">
          <div>
